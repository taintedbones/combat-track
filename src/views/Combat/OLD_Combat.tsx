...
import CombatToolbar from "./components/CombatStart/CombatToolbar";
...
import CombatSetupToolbar from "./components/CombatSetup/SetupToolbar";
...
export default function Combat() {
  ...
  const { loading, scenario } = useScenario("skeletons");
